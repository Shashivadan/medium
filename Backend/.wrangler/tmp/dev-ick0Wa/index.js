...
// .wrangler/tmp/bundle-2aYcRv/checked-fetch.js
...
// .wrangler/tmp/bundle-2aYcRv/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-2aYcRv/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
async function prisma(c, next) {
  const prisma2 = new import_edge3.PrismaClient({
    datasourceUrl: c.env.DATABASE_URL
  }).$extends(withAccelerate());
